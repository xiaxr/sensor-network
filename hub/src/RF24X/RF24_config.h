...
//#define SERIAL_DEBUG
//#define MINIMAL
//#define SPI_UART    // Requires library from
// https://github.com/TMRh20/Sketches/tree/master/SPI_UART #define SOFTSPI //
...
// ATXMega
#if defined(__AVR_ATxmega64D3__) || defined(__AVR_ATxmega128D3__) ||           \
    defined(__AVR_ATxmega192D3__) || defined(__AVR_ATxmega256D3__) ||          \
    defined(__AVR_ATxmega384D3__) // In order to be available both in Windows
                                  // and Linux this should take presence here.
#define XMEGA
#define XMEGA_D3
#include "utility/ATXMegaD3/RF24_arch_config.h"

#elif (!defined(                                                               \
    ARDUINO)) // Any non-arduino device is handled via configure/Makefile
// The configure script detects device and copies the correct includes.h file to
// /utility/includes.h This behavior can be overridden by calling configure with
// respective parameters The includes.h file defines either RF24_RPi, MRAA,
// LITTLEWIRE or RF24_SPIDEV and includes the correct RF24_arch_config.h file
#include "rpi/includes.h"

// ATTiny
#elif defined(__AVR_ATtiny25__) || defined(__AVR_ATtiny45__) ||                \
    defined(__AVR_ATtiny85__) || defined(__AVR_ATtiny24__) ||                  \
    defined(__AVR_ATtiny44__) || defined(__AVR_ATtiny84__) ||                  \
    defined(__AVR_ATtiny2313__) || defined(__AVR_ATtiny4313__) ||              \
    defined(__AVR_ATtiny861__) || defined(__AVR_ATtinyX5__) ||                 \
    defined(__AVR_ATtinyX4__) || defined(__AVR_ATtinyX313__) ||                \
    defined(__AVR_ATtinyX61__)
#define RF24_TINY
...
#endif
#elif defined(ARDUINO) && !defined(ESP_PLATFORM) && !defined(__arm__) &&       \
        !defined(__ARDUINO_X86__) ||                                           \
    defined(XMEGA)
#include <avr/pgmspace.h>
#define PRIPSTR "%S"

#else // !defined (ARDUINO) || defined (ESP_PLATFORM) || defined (__arm__) ||
      // defined (__ARDUINO_X86__) && !defined (XMEGA)
...
#endif // !defined (ARDUINO) || defined (ESP_PLATFORM) || defined (__arm__) ||
       // defined (__ARDUINO_X86__) && !defined (XMEGA)
